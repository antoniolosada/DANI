...
def leer_jugada():
    ...
    global count_piedra
    global count_papel
    global count_tijeras
    global count_restart
    ...
    with mp_hands.Hands(
         ...
         while True:
              ...
              if results.multi_hand_landmarks:
                   fingers = fingers_up_down(results, thumb_points, palm_points, fingertips_points, finger_base_points, height, width, frame)
...
image_winner = cv2.imread("images/3.jpg")
image_tie = cv2.imread("images/4.jpg")
image_loser = cv2.imread("images/5.jpg")
# Image to concat
imAux = image1
player = None
...
#leer_jugada_imagen("images/frame.jpg")
